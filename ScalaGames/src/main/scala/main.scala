...
object MainMenu {
    ...
    def solveSuduko(state:Array[Int]): Array[Int] = {
        val q1 = new Query("consult('/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/suduko.pl')")
        q1.hasSolution

        val boardArray = state
    ...
    def solveQueens(state: Array[Int]): Array[Int] = {
        // init prolog file
        val q = new Query("consult('/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/solveQueens.pl')")
        q.hasSolution
    ...
    def TicTacToeDrawer(state: Array[Int]): Unit = {
        val XSymbol: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/TicTacToe/x.png"))
              .getScaledInstance(140, 140, Image.SCALE_SMOOTH)

        val OSymbol: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/TicTacToe/o.jpeg"))
              .getScaledInstance(140, 140, Image.SCALE_SMOOTH)
    ...
    def drawBoard(gfx: Graphics, state: Array[Int]): Unit = {
        ...
        val whiteCircle: Image =
            ImageIO
              .read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala//home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Checkers/whiteCircle.png"))
              .getScaledInstance(40, 40, Image.SCALE_SMOOTH)
        val blackCircle: Image =
            ImageIO
              .read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala//home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Checkers/blackCircle.png"))
              .getScaledInstance(40, 40, Image.SCALE_SMOOTH)
        gfx.setFont(font)
    ...
    def ChessDrawer(state: Array[Int]): Unit = {
        ...
        val blackpawn: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala//home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/black/pawn.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val whitepawn: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/white/pawn.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val blackking: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/black/king.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val whiteking: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/white/king.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)


        val blackqueen: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/black/queen.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val whitequeen: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/white/queen.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val blackrook: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/black/rook.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val whiterook: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/white/rook.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val blackbishop: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/black/bishop.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val whitebishop: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/white/bishop.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val blackknight: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/black/knight.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)

        val whiteknight: Image =
            ImageIO.read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Chess/white/knight.png"))
              .getScaledInstance(30, 30, Image.SCALE_SMOOTH)
    ...
    def generateSudoku(): Array[Int] = {
        ...
        removeNumbers(board, 0.7) // remove 50% of the numbers
        board
    }
    ...
    def queenDrawBoard(gfx: Graphics, state: Array[Int]): Unit = {
        ...
        val queen: Image =
            ImageIO
              .read(new File("/home/ahmed/level2term2/paradigms/testjpl/src/main/scala/Assets/Queen/queen.png"))
              .getScaledInstance(40, 40, Image.SCALE_SMOOTH)
        gfx.setFont(font)
